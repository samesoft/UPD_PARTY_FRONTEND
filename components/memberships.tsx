...
export default function MembershipPage() {
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white px-2 sm:px-5 pt-4 sm:pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            ...
            {/* Pagination Controls */}
            <div className="flex items-center justify-between gap-4 mt-4 overflow-x-auto py-4">
                <button
                    className="bg-green-500 text-white px-4 py-2 rounded disabled:opacity-50 hover:bg-green-600 whitespace-nowrap"
                ...
                <div className="flex items-center gap-2">
                    {pagination.totalPages > 5 && pagination.page > 3 && (
                        <>
                            <button
                                className="px-3 py-2 rounded bg-green-500 text-white hover:bg-green-600 text-xs sm:text-sm"
