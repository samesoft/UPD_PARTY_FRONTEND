...
import { User, Mail, MapPin, Book, Users, Briefcase, ChevronRight, Phone } from 'lucide-react';
...
export default function UserMembershipPage() {
    ...
    const [membLevelsOptions, setMembLevelsOptions] = useState<MembershipLevelResponse>({ data: [] });
    const [districtOptions, setDistrictOptions] = useState<ApiResponse>({ data: [] });
    const [ageGroupOptions, setAgeGroupOptions] = useState<AgeGroupResponse>({ data: [] });
    const [eduLevelOptions, setEduLevelOptions] = useState<EduLevelResponse>({ data: [] });
    const [partyRoleOptions, setPartyRoleOptions] = useState<PartyRoleResponse>({ data: [] });
    ...
    useEffect(() => {
        const fetchDropdownOptions = async () => {
            try {
                const [membLevels, districts, ageGroups, eduLevels, partyRoles] = await Promise.all([
