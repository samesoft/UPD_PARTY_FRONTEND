...
import { User, Users, ChevronRight, Phone, Eye, EyeOff } from "lucide-react";
...
export default function UserMembershipPage() {
  ...
  const handleInputChange = (
    ...
    if (name === "state_id") {
      ...
      if (stateId) {
        getRegionsByState(stateId).then((res) => {
          setRegions(res);
        });
          ...
          <div className="bg-white rounded-lg p-4 sm:p-8 shadow-xl z-10 max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Diwaangelinta xubinimadaada ayaa si guul leh loo dhammeystiray.
              </p>
              <button
