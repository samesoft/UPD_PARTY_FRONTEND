...
export default function EventListing() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const response = await axiosInstance.get("/state/cleaned");
  ...
  const fetchEvents = async (page: number = 1) => {
    setIsLoading(true);
    try {
      const state_id = stateId ? stateId : localStorage.getItem("state_id");
  ...
  }, [pagination.page, searchTitle, stateId]);
  ...
  return (
    <div className="rounded-lg border border-stroke bg-white px-6 pt-6 pb-4 shadow-lg dark:border-strokedark dark:bg-boxdark sm:px-8 xl:pb-2">
      ...
      <div className="mb-4">
        <Select value={stateId} onValueChange={setStateId}>
          ...
          <SelectContent>
            {states.map((state) => {
              return (
                <SelectItem value={state.stateid}>{state.state}</SelectItem>
              );
            })}
          </SelectContent>
        </Select>
          ...
          {events.map((event) => (
            ...
            >
              <div className="flex flex-col h-full relative z-10">
                <div
                  className="absolute -top-20 -right-20 w-40 h-40 bg-green-100 rounded-full 
                ...
                <div className="space-y-3 text-gray-600 dark:text-gray-300 flex-grow">
                  ...
                  >
                    <svg
                      className="w-5 h-5 mr-2 text-green-500 transition-transform 
        ...
        <div className="flex flex-col items-center justify-center py-12 px-4">
          ...
          <div className="max-w-md text-center space-y-4">
            <p className="text-gray-500 dark:text-gray-400">
              There are currently no events scheduled for your state. Check back
            ...
            <div className="mt-8 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Events are typically added Most of the time. Stay tuned for
                exciting upcoming activities in your area!
              </p>
            </div>
          </div>
        </div>
      ...
      {selectedEvent && (
        ...
        >
          <div
            className="bg-white dark:bg-boxdark p-8 rounded-2xl shadow-2xl max-w-md w-full mx-4 
          ...
          >
            ...
            <div className="mb-6">
              ...
              >
                ...
                <span
                  className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r 
                                       from-green-400 to-green-600 transform origin-left scale-x-100"
                ></span>
              </h2>
            </div>
